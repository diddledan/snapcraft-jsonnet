...
module_dir = os.path.join(__location__, "../src/sc_jsonnet")
try:
...
try:
    from sc_jsonnet import __version__ as version
except ImportError:
    pass
else:
    release = version
...
htmlhelp_basename = 'sc_jsonnet-doc'
...
latex_documents = [
  ('index', 'user_guide.tex', u'sc-jsonnet Documentation',
